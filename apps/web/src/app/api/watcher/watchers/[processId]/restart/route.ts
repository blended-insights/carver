...
/**
 * Handle POST requests to restart a watcher
 */
export async function POST(
  ...
  try {
    ...
    const response = await axios.post(
      `${WATCHER_API_URL}/watchers/${encodeURIComponent(processId)}/restart`,
      {},
      {
        headers: {
    ...
    return applyCorsHeaders(
      ...
      NextResponse.json(
        {
          success: false,
          message: 'An error occurred while restarting the watcher',
